...
/**
 * Pixelkorea Home Page - Minimal & Professional
 * Design Philosophy: Clean, simple, information-focused
 * Color: Professional Blue (#0052cc) with neutral backgrounds
 * Typography: Pretendard for clear hierarchy
 */
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm">
            <a href="#solutions" className="hover:text-primary transition">솔루션</a>
            <a href="#projects" className="hover:text-primary transition">프로젝트</a>
            <a href="#about" className="hover:text-primary transition">회사소개</a>
            <a href="/blog" className="hover:text-primary transition">블로그</a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {solutions.map((solution) => (
              <div key={solution.id} className="border border-border rounded-lg p-8 hover:border-primary transition">
                <h3 className="text-2xl font-bold mb-2">{solution.name}</h3>
                <p className="text-sm text-primary font-medium mb-4">{solution.subtitle}</p>
      ...
      {/* Why Us Section */}
      <section id="about" className="py-20 md:py-32 bg-blue-50">
        <div className="max-w-6xl mx-auto px-6">
      ...
      <section id="projects" className="py-20 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
              ...
              <button
                ...
                className={`px-4 py-2 rounded text-sm font-medium transition ${
                  activeTab === tab
                    ...
                    : "bg-secondary text-foreground hover:bg-blue-50"
                }`}
              >
                {tab === "all" && "모든 프로젝트"}
                {tab === "dome" && "돔 영상관"}
              ...
              >
                <div className="h-48 bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-primary mb-2">#{project.id}</div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-xs text-primary font-medium">{project.year}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <a href="#" className="text-primary font-medium hover:underline flex items-center justify-center gap-2">
              모든 프로젝트 보기
              <ArrowRight className="w-4 h-4" />
            </a>
          </div>
      ...
      {/* Blog Preview */}
      <section id="blog" className="py-20 md:py-32 bg-blue-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-lg border border-border hover:border-primary transition">
                <p className="text-xs text-primary font-medium mb-2">{post.category}</p>
          ...
          <div className="text-center mt-12">
            <a href="/blog" className="text-primary font-medium hover:underline flex items-center justify-center gap-2">
              모든 포스트 보기
              <ArrowRight className="w-4 h-4" />
            </a>
          </div>
      ...
      <section className="py-20 md:py-32 bg-primary text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">프로젝트 상담이 필요하신가요?</h2>
